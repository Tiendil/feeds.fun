...
async def load_content(  # noqa: CFQ001, CCR001, C901 # pylint: disable=R0912, R0915
    ...
    # - build a dashboard to monitor errors and react on their spikes
        ...
        elif "illegal header line" in message:
        ...
        if message == "":
            error_code = FeedError.network_write_error
            log.warning("network_write_error")
        else:
            log.exception("unknown_write_error_while_loading_feed")
