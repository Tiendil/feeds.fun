...
def _full_settings(values: dict[int, str], kinds: Iterable[int], register: SettingsRegister) -> UserSettings:
    result = {}
...
async def get_users_with_setting(kind: int, value: object, register: SettingsRegister = user_settings) -> set[UserId]:
