...
_default_sitemaps = ["/sitemaps/pages.xml",
                     "/blog/sitemap.xml"]
...
class Settings(BaseSettings):
    ...
    robots_extra_disallowed_paths: list[str] = pydantic.Field(default_factory=lambda: list(_default_robots_extra_disallowed_paths))
