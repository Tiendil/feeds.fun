...
class TestCreateOrUpdateRule:
    ...
    async def test_create_new_rule(
        ...
        required_tags = five_tags_ids[:3]  # type: ignore
        excluded_tags = five_tags_ids[3:]  # type: ignore
        ...
        with capture_logs() as logs:  # type: ignore
            async with TableSizeDelta("s_rules", delta=1):
                created_rule = await operations.create_or_update_rule(
                    internal_user_id,
                    score=13,
                    required_tags=required_tags,  # type: ignore
                    excluded_tags=excluded_tags,  # type: ignore
                )
        ...
        assert created_rule.required_tags == set(required_tags)  # type: ignore
        assert created_rule.excluded_tags == set(excluded_tags)  # type: ignore
        ...
        assert_logs_has_business_event(
            ...
            required_tags=list(required_tags),  # type: ignore
            excluded_tags=list(excluded_tags),  # type: ignore
            score=13,
        )
        assert_logs_has_no_business_event(logs, "rule_updated")  # type: ignore

    @pytest.mark.asyncio
    async def test_tags_order_does_not_affect_creation(
        self, internal_user_id: UserId, five_tags_ids: tuple[TagId, TagId, TagId, TagId, TagId]
    ) -> None:
        required_tags = list(five_tags_ids[:3])  # type: ignore
        excluded_tags = list(five_tags_ids[3:])  # type: ignore
    ...
    async def test_update_scores_of_existed_rule(
        ...
        assert_logs_has_no_business_event(logs, "rule_created")  # type: ignore
    ...
    async def test_multiple_entities(
        ...
        await operations.create_or_update_rule(
            internal_user_id,
            required_tags=five_tags_ids[:2],  # type: ignore
            excluded_tags=five_tags_ids[-2:],  # type: ignore
            score=3,
        )
        await operations.create_or_update_rule(
        ...
        await operations.create_or_update_rule(
            another_internal_user_id,
            required_tags=five_tags_ids[1:],  # type: ignore
            excluded_tags=five_tags_ids[:1],  # type: ignore
            score=7,
        )
        await operations.create_or_update_rule(
            internal_user_id,
        ...
        assert rules[0].required_tags == set(five_tags_ids[:2])  # type: ignore
        assert rules[0].excluded_tags == set(five_tags_ids[-2:])  # type: ignore
        ...
        assert rules[1].required_tags == set(five_tags_ids[1:])  # type: ignore
        assert rules[1].excluded_tags == set(five_tags_ids[:1])  # type: ignore
    ...
    async def test_tags_intersection(
        ...
        assert len(set(required_tags) & set(excluded_tags)) == 1  # type: ignore
...
class TestDeleteRule:
    ...
    async def test_delete_rule(
        ...
        rule_2 = await operations.create_or_update_rule(
            internal_user_id, required_tags=three_tags_ids[:2], excluded_tags=[], score=17  # type: ignore
        )
    ...
    async def test_delete_not_existed_rule(self, internal_user_id: UserId) -> None:
        ...
        assert_logs_has_no_business_event(logs, "rule_deleted")  # type: ignore
...
class TestUpdateRule:
    ...
    async def test_update_rule(
        ...
        with capture_logs() as logs:  # type: ignore
            async with TableSizeNotChanged("s_rules"):
                updated_rule = await operations.update_rule(
                    internal_user_id,
                    rule_to_update.id,
                    required_tags=five_tags_ids[:4],  # type: ignore
                    excluded_tags=five_tags_ids[4:],  # type: ignore
                    score=17,
                )

        assert updated_rule.id == rule_to_update.id
        assert updated_rule.user_id == internal_user_id
        assert updated_rule.required_tags == set(five_tags_ids[:4])  # type: ignore
        assert updated_rule.excluded_tags == set(five_tags_ids[4:])  # type: ignore
        assert updated_rule.score == 17
        ...
        assert_logs_has_business_event(
            ...
            required_tags=list(five_tags_ids[:4]),  # type: ignore
            excluded_tags=list(five_tags_ids[4:]),  # type: ignore
            score=17,
        )
            ...
            async with TableSizeNotChanged("s_rules"):
                with pytest.raises(errors.NoRuleFound):
                    await operations.update_rule(
                        internal_user_id,
                        new_rule_id(),
                        required_tags=three_tags_ids[:2],  # type: ignore
                        excluded_tags=three_tags_ids[2:],  # type: ignore
                        score=17,
                    )
    ...
    async def test_wrong_user(
        ...
        rule_to_update = await operations.create_or_update_rule(
            internal_user_id, required_tags=three_tags_ids[:2], excluded_tags=[], score=13  # type: ignore
        )
    ...
    async def test_tags_intersection(
        ...
        rule_to_update = await operations.create_or_update_rule(
            internal_user_id, required_tags=five_tags_ids[:3], excluded_tags=[], score=13  # type: ignore
        )

        assert set(five_tags_ids[:3]) & set(five_tags_ids[2:])  # type: ignore
