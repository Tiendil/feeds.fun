...
class TestGetScore:
    ...
    @pytest.mark.parametrize("rules, tags, contributions",
                             [[[],
                               set(),
                               (0, {})],
                              ...
                              [[rule(4, {1, 2}), rule(5, {1, 3})],
                               {1, 2, 3, 4},
                               (9, {1: 9, 2: 4, 3: 5})],

                              [[rule(6, {1, 2}), rule(-7, {3, 5}), rule(8, {1, 4})],
                               {2, 3, 4},
                               (0, {})],

                              [[rule(9, {1, 2}), rule(-10, {3, 5}), rule(11, {4, 5})],
                               {2, 3, 4, 5},
                               (1, {3: -10, 4: 11, 5: 1})],

                              [[rule(9, {1, 2}), rule(-10, {3, 5}), rule(11, {4})],
                               {2, 3, 4, 5},
                               (1, {3: -10, 4: 11, 5: -10})],

                              [[rule(12, {1, 2}), rule(-12, {2, 3})],
                               {1, 2, 3, 4, 5},
                               (0, {1: 12, 2: 0, 3: -12})],
                              ])
