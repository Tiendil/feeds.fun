...
from ffun.domain.entities import UnknownUrl, CollectionId, FeedUrl
...
async def run_entries_per_day_for_collection(collection_id: uuid.UUID) -> None:
    async with with_app():
        ...
        logger.info('estimated_entries_for_feed_in_day', collection_id=collection_id, entries_per_day=total_entries_per_day)
