...
- `specs/backend_architecture/modules/benefits.md` describes configured benefit package templates, package materialization, the all-source transaction and provider-provenance ledger, and atomic application to purchased states and entitlements.
...
- `specs/behavior/cli/benefits.md` describes administrator application of benefit transactions to subscriptions and one-time purchases.
