  ...
  <wide-layout>
    <div class="max-w-xl mx-auto px-6 py-12 text-center">
      ...
      <p class="text-gray-600 mb-6">
        We are ending your current session. You will be redirected automatically.
      </p>
      <p class="text-sm text-gray-500">If nothing happens, <a :href="logoutUrl" class="text-indigo-600">click here</a>.</p>
    </div>
  </wide-layout>
</template>
