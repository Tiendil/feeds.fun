      ...
      <form class="space-y-6" @submit.prevent="submit">
        <div>
          ...
          <input
            ...
            required
          />
          <p v-for="message in fieldErrors['traits.email']" :key="message" class="mt-1 text-sm text-red-600">
            {{ message }}
          </p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500"
          />
          <p v-for="message in fieldErrors['traits.name']" :key="message" class="mt-1 text-sm text-red-600">
            {{ message }}
          </p>
        </div>
