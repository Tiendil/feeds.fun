...
3. Create a custom `models.toml` config with the parameters of the used model.
...
This particular configuration tells Feeds Fun to access the service you have running locally on your host machine
...
2. Configure and run LMStudio server on your host machine, binding it to the port `1234`. See the screenshot below.
3. Do not forget to load the model into memory via LMStudio interface.
